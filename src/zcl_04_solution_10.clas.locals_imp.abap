  ...
  PRIVATE SECTION.
    ...
    TYPES:
      BEGIN OF st_connections_buffer,
        ...
        airport_to_id   TYPE /dmo/airport_to_id,
        departure_time  TYPE /dmo/flight_departure_time,
        timzone_from    TYPE /lrn/airport-timzone,
        arrival_time    TYPE /dmo/flight_departure_time,
        timzone_to      TYPE /lrn/airport-timzone,
...
*      INTO TABLE @DATA(airports).
    ...
    FIELDS carrier_id, connection_id,
           airport_from_id, airport_to_id, departure_time, f~timzone AS timzone_from,
           arrival_time, t~timzone AS timzone_to,
           div( tstmp_seconds_between(
...
*              TIME ZONE connections_buffer[ airport_from_id = connection-airport_from_id ]-timzone_from
*              INTO UTCLONG DATA(departure_utclong).
*
*      CONVERT DATE today
*              TIME connection-arrival_time
*              TIME ZONE connections_buffer[ airport_to_id = connection-airport_to_id ]-timzone_to
...
*           TO r_result.
    ...
    DATA(duration) = connection_details-duration.
    ...
    APPEND |{ 'Duration:'(011)       } { duration / 60 }h { duration MOD 60 }m| TO r_result.
